var Shader = (function () {
    ...
    code = {},
        ...
        }), Shader.colorVertexShader.id = 'colorVertexShader',
        ...
        }), Shader.colorFragmentShader.id = 'colorFragmentShader',
        ...
        }), Shader.wireFrameVertexShader.id = 'wireFrameVertexShader',
        Shader.wireFrameFragmentShader = new Shader({
            ...
            'gl_FragColor =  vColor;' +
            '']
        }), Shader.wireFrameFragmentShader.id = 'wireFrameFragmentShader',
        ...
        }), Shader.bitmapVertexShader.id = 'bitmapVertexShader',
        ...
        }), Shader.bitmapFragmentShader.id = 'bitmapFragmentShader',
        ...
        }), Shader.colorVertexShaderGouraud.id = 'colorVertexShaderGouraud',
        ...
        }), Shader.colorFragmentShaderGouraud.id = 'colorFragmentShaderGouraud',
        ...
        }), Shader.bitmapVertexShaderGouraud.id = 'bitmapVertexShaderGouraud',
        ...
        }), Shader.bitmapFragmentShaderGouraud.id = 'bitmapFragmentShaderGouraud',
        ...
        }), Shader.colorVertexShaderPhong.id = 'colorVertexShaderPhong',
        ...
        }), Shader.colorFragmentShaderPhong.id = 'colorFragmentShaderPhong',
        ...
        }), Shader.toonVertexShaderPhong.id = 'toonVertexShaderPhong',
        ...
        }), Shader.toonFragmentShaderPhong.id = 'toonFragmentShaderPhong',
        ...
        }), Shader.bitmapVertexShaderPhong.id = 'bitmapVertexShaderPhong',
        ...
        }), Shader.bitmapFragmentShaderPhong.id = 'bitmapFragmentShaderPhong',
        ...
        }), Shader.bitmapVertexShaderBlinn.id = 'bitmapVertexShaderBlinn',
        ...
        }), Shader.bitmapFragmentShaderBlinn.id = 'bitmapFragmentShaderBlinn',
        ...
        }), Shader.postBaseVertexShader.id = 'postBaseVertexShader',
        Shader.postBaseFragmentShader = new Shader({
            ...
            '}' +
            '']
        }), Shader.postBaseFragmentShader.id = 'postBaseFragmentShader'
